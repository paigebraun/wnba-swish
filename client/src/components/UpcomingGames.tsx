    ...
    const sortedGames = games
        ...
        .sort((a, b) => {
            ...
            if (dateA.getTime() !== dateB.getTime()) {
                ...
                const timeA = a.status.includes("ET")
                    ? parseGameTime(a.status).getTime()
                    : 0;
                const timeB = b.status.includes("ET")
                    ? parseGameTime(b.status).getTime()
                    : 0;
                return timeA - timeB;
            }
        });
    ...
    return (
        <>
                            ...
                            .map((game, index) => (
                                <motion.div
                                    ...
                                    <div className="flex flex-col items-end w-1/4">
                                        <p className="text-wOrange font-bold">
            ...
            <div className="display-block lg:hidden">
                <h1 className="font-bold text-2xl md:text-4xl mt-10 text-left">
                    Upcoming
                </h1>
                                ...
                                <motion.div
                                    ...
                                    <div className="flex items-center gap-4 w-full">
                                        <div className="flex flex-col items-center justify-center bg-white min-w-fit p-2 rounded-lg md:px-4 w-24 md:w-36">
                                            <p className="text-wOrange font-semibold text-xl md:text-2xl">
                                                {
                                                    formatDateMobile(game.date)
                                                        .day
                                                }
