...
function PlayerInfo() {
    ...
    return (
        <div className="flex w-full relative gap-10 mt-10">
            <div className="flex bg-gray-100 rounded h-fit max-w-64">
            ...
            <div className="flex flex-col w-full">
                ...
                <div className="grid grid-cols-2 gap-2 gap-x-10 mt-2 w-fit">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-2xl font-bold">{formatDateString(dob)}</p>
                    </div>
                    <div className="flex flex-col">
                        <p className="text-xs">PRIOR</p>
                        <p className="text-2xl font-bold">{prior}</p>
                    </div>
                    <div className="flex flex-col">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-2xl font-bold">{exp}</p>
                    </div>
                </div>
            </div>
