...
const getOptions = (playerId) => {
  ...
  return {
      ...
      headers: {
          ...
          'Host': 'stats.wnba.com',
          'Referer': `https://stats.wnba.com/events/?flag=3&CFID=&CFPARAMS=&PlayerID=${playerId}&TeamID=0&GameID=&ContextMeasure=FGA&Season=2024&SeasonType=Regular%20Season&LeagueID=10&PerMode=PerGame&Split=lastn&PlusMinus=N&PaceAdjust=N&Rank=N&Outcome=&Location=&Month=0&SeasonSegment=&OpponentTeamID=0&VsConference=&VsDivision=&GameSegment=&Period=0&LastNGames=0&DateFrom=&DateTo=&PORound=0&ShotClockRange=&MeasureType=Base&section=player&sct=hex&CF=PLAYER_NAME*E*`
      },
    ...
    try {
        ...
        const insertQuery = `
            ...
            DO UPDATE SET 
                ...
                shots = EXCLUDED.shots || player_shots.shots
        `;
